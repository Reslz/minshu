...
public class QueryHouseServiceImpl implements QueryHouseService{
	...
	@Override
	public Integer getTotalCounts(QueryHouseResult qh) {
		// TODO Auto-generated method stub
		Integer totalCounts = qhMapper.getTotalCounts(qh);
		return totalCounts;
	}

	@Override
	public List<String> getSheShi(List<Integer> list) {
		// TODO Auto-generated method stub
		List<String> sheShi = qhMapper.getSheShi(list);
		return sheShi;
	}
