...
public class HouseListController {
	...
	public List<HouseListInfo> houseList(int uid,int startindex,int pageSize){
		List<HouseListInfo> list = houseListService.houseList(uid,startindex,pageSize);
		return list;
	}
	...
	public LocationInfo showHouseLoction(int locationid) {
		LocationInfo m = houseListService.showHouseLoction(locationid);
		return m;
	}
	@RequestMapping("/showHouseInfo")
	@ResponseBody
	public HouseListInfo showHouseInfo(int houseid) {
		HouseListInfo h = houseListService.showHouseInfo(houseid);
		return h;
	}
