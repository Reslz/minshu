		...
		$.post(base_path+"ly/getTieziPageList",
			...
			function(data){
				...
				str +="<div class='col-md-4 col-sm-6 col-xs-12 b_packages'>"+
							"<div class='v_place_img' ><a href='detail.html?tieziid="+data[i].tieziid+"'><img src='"+data[i].img+"' style='width: 350px; height: 262.5px;' alt='"+data[i].fenlei+"' title='"+data[i].fenlei+"' /></a></div>"+
			...
			function(data){
				...
				for(var i=0;i<data.length;i++){
					...
					str += 	"<div class='col-md-4'><div class='to-ho-hotel-con'><div class='to-ho-hotel-con-1'>"+
							...
							"<div class='to-ho-hotel-con-2'><h4>马卡龙B·解放碑旁近轻轨地铁站</h4></div>"+
							"<div class='to-ho-hotel-con-3'><ul><li>城市：重庆</li>"+
							"<li><span class='ho-hot-pri-dis'>"+data[i].oldprice+"</span><span class='ho-hot-pri'>￥"+data[i].newprice+"</span></li></ul></div>"+
							"<div class='to-ho-hotel-con-4'><a href='booking1.html' class='link-btn hom-hot-book-btn'>预定</a><a href='hotel-details.html' class='link-btn hom-hot-view-btn'>详情</a>"+
							"</div></div></div></div>"                       
			}
			$("#btn2").html(str);			
		});
